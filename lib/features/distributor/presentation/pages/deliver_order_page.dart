...
class _DeliverOrderPageState extends State<DeliverOrderPage> {
  ...
  Future<void> _confirm() async {
    ...
    if (pin.length != 6) {
      setState(() {
        _error = 'Enter all 6 digits of the shop owner PIN.';
      });
      return;
    }
    setState(() {
            ...
            : Column(
                ...
                children: [
                  ...
                  if (!_pinSent) ...[
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'PIN sent to shop owner\'s activity center. Ask them to check their app.',
                              style: theme.textTheme.bodyMedium?.copyWith(
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'Ask the shop owner to read the 6-digit PIN from their activity center.',
                      style: theme.textTheme.bodyMedium?.copyWith(
                        color: AppTheme.textSoft,
                      ),
                    ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Order has been marked as completed for the shop owner and territory manager.',
              textAlign: TextAlign.center,
              style: Theme.of(
                context,
