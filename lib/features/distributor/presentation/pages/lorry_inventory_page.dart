...
class LorryInventoryPage extends StatefulWidget {
  const LorryInventoryPage({super.key, required this.assignment});
...
class _LorryInventoryPageState extends State<LorryInventoryPage> {
  ...
  double get _totalValue =>
      widget.assignment.lorryInventory.fold(0, (sum, i) => sum + i.lineTotal);
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              widget.assignment.vehicleLabel ?? 'Vehicle',
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              '${widget.assignment.lorryInventory.fold<int>(0, (s, i) => s + i.quantity)} cases',
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              'LKR ${_totalValue.toStringAsFixed(0)}',
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'LKR ${item.unitPrice.toStringAsFixed(2)} / case',
                                    style: theme.textTheme.bodySmall?.copyWith(
                                      color: AppTheme.textSoft,
                                    ),
                                  ),
